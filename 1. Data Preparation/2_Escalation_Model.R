...
#For Clara
load("/Users/clarita/Desktop/Consulting Bewaffnete Konflikte/Datasets_Africa/data_cm.Rdata")
...
X1mo_data <-read_dta("C:/Users/NUTELLA/Documents/Consulting Bewaffnete Konflikte/Paper Consulting/ForecastingCivilWars_BlairSambanis/replication-3/data/1mo_data.dta")

#For CIP POOL
load("C:/Users/ru23kek/Downloads/data_cm.Rdata")


#Modify Variables
data_cm$year <- as.numeric(data_cm$year)
data<-data_cm
data<- data %>% mutate(Country = replace(Country, Country == "Congo", "Democratic Republic of Congo"),
...
load("C:/Users/ru23kek/Downloads/pgm_data.RData")
...
#write.csv(cm_icews_data, file="C:/Users/ru23kek/Downloads/cm_icews_data.csv")
#write.csv(pgm_icews_data, file="C:/Users/ru23kek/Downloads/pgm_icews_data.csv")
