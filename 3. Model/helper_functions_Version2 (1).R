...
#Keep only two countries
cm_data<-cm_data%>%filter(country_name=="South Africa" | country_name=="Nigeria")
pgm_data<-pgm_data%>%filter(country_name=="South Africa" | country_name=="Nigeria")
