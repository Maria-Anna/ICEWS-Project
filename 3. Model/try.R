...
dir.create(path = "Prediction_ICEWS_try2")
...
for(i in 1:length(dates)){
  for(s in s_values) {
    ...
    date_change = paste0("Prediction_ICEWS_try2/final_treshold", gsub(pattern = "-",replacement = "_",x = tmp_date), "_s_",s,".csv" )
    ...
    date_change = paste0("Prediction_ICEWS_try2/with_mcw_result_t_",gsub(pattern = "-",replacement = "_",x = tmp_date), "_s_",s,".csv" )
...
for(s in s_values) {
  ...
  date_change = paste0("Prediction_ICEWS_try2/real_mcw_forecast_t_",gsub(pattern = "-",replacement = "_",x = tmp_date), "_s_",s,".csv" )
  ...
  if(s == 2){
    save(try_model_1,file =  "Prediction_ICEWS_try2/models/try_model_1.RData")
    save(try_model_2,file =  "Prediction_ICEWS_try2/models/try_model_2.RData")
    save(try_model_3,file =  "Prediction_ICEWS_try2/models/try_model_3.RData")
    data_pg = all_data$pgm_data_comp
    save(data_pg, file = "Prediction_ICEWS_try2/models/data_pg.RData")
    data_c = all_data$cm_data_comp
    save(data_c, file = "Prediction_ICEWS_try2/models/data_c.RData")
  }
