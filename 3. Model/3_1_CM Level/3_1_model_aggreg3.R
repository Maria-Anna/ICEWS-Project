...
path_prediction<-"~/ICEWS-Project/3. Model/Predictions/Prediction_ICEWS_Aggr"
...
#save data sets
write.csv(cm_data, file="~/ICEWS-Project/Data/cm_aggregate.csv", row.names = F)
write.csv(pgm_data, file="~/ICEWS-Project/Data/pgm_aggregate.csv", row.names = F)

#load data sets
cm_data<-fread("~/ICEWS-Project/Data/cm_aggregate.csv")
pgm_data<-fread("~/ICEWS-Project/Data/pgm_aggregate.csv")
