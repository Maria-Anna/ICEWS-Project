...
#Display Plots
p<-grid.arrange(a,b,c,ncol=1,nrow=3)


#Save Plots
ggsave(p, filename = paste(path_plots, "/dynamic_burundi.png", sep=""), width = 12, height = 15)
...
#GGPLOT
a<- ggplot(filter(data))+
  geom_sf(aes(group=country_name, fill= gov_opp_accommodations))+
